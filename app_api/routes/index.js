...
router
    ...
    .post(authenticateJWT, tripsController.tripsAddTrip); // POST: /trips - add a new trip
...
router
    ...
    .put(authenticateJWT, tripsController.tripsUpdateTrip) // PUT: /trips/:tripCode - updates a single trip
